...
map <- rider_countries_2018 %>% 
    ...
    # geom_text(aes(long, lat, label = country), data = country_names,
    #           color = "transparent") +
    #coord_quickmap() +
...
# %>% layout(xaxis = list(range = c(-55, 80)))
```
...
Social convention dictates that you don't ask a woman her age, but anyone with a professional cycling license is not afforded that luxary because your birthday is publicly available. So...what is the age distribution of elite cyclists?
...
The average lenght of time a rider stays in the professional peloton is 2.85 years with a range of 1 to 15 seasons (the length of the dataset).
